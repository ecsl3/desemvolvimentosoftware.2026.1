...
export default function DiagnosticPage() {
  ...
  // Novo Componente Expansível (Acordeão) para a Literatura
    ...
    return (
      <div className="mt-6 border border-blue-900/50 rounded-xl overflow-hidden transition-all duration-300">
        <button
          ...
          className="w-full p-4 flex items-center justify-between bg-blue-950/20 hover:bg-blue-950/40 text-blue-300 text-sm font-medium transition-colors focus:outline-none"
        >
          <span className="flex items-center gap-2">
            <span className="text-lg">💡</span> O que a ciência diz?
          </span>
        ...
        {isOpen && (
          <div className="p-4 bg-blue-950/10 text-sm text-blue-200 border-t border-blue-900/50 leading-relaxed animate-in slide-in-from-top-2 duration-200">
            {texto}
          </div>
        )}
      </div>
            ...
            <div className="flex-1 flex flex-col mt-8">
              <div className="flex-1 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                {currentStep === 0 && (
                  <div>
                    ...
                    <LiteraturaCard texto="A arquitetura do sono muda com a idade (jovens têm mais sono profundo; idosos têm sono mais fragmentado). O gênero influencia devido a flutuações hormonais que afetam o ritmo circadiano e a temperatura corporal." />
                  </div>
                )}
                ...
                {currentStep === 2 && (
                  <div>
                    ...
                    <LiteraturaCard texto="Avalia o alinhamento com o ciclo de luz/escuro. Ir dormir após as 02:00 pode indicar um cronotipo vespertino extremo ou 'jet lag social', comum em estudantes e profissionais de tecnologia." />
                  </div>
                )}
                ...
                {currentStep === 3 && (
                  <div>
                    ...
                    <LiteraturaCard texto="A latência ideal é entre 10 e 20 minutos. Menos de 5 minutos pode indicar privação severa de sono; mais de 30 minutos é um critério clínico para diagnóstico de insônia inicial." />
                  </div>
                )}
                ...
                {currentStep === 4 && (
                  <div>
                    ...
                    <LiteraturaCard texto="Despertares frequentes impedem o corpo de completar os ciclos de sono REM e N3 (sono profundo), essenciais para a restauração física e cognitiva." />
                  </div>
                )}
                ...
                {currentStep === 5 && (
                  <div>
                    <h3 className="text-xl font-semibold mb-6">5. Higiene do Sono: Qual o horário do seu último consumo de cafeína/estimulantes?</h3>
                    <div className="grid gap-3">
                    ...
                    <LiteraturaCard texto="A cafeína tem uma meia-vida de cerca de 5 a 6 horas. O consumo após as 16h bloqueia os receptores de adenosina no cérebro, impedindo que você sinta pressão de sono natural." />
                  </div>
                )}
                ...
                {currentStep === 6 && (
                  <div>
                    <h3 className="text-xl font-semibold mb-6">6. Higiene do Sono: Como é seu uso de telas nos 30 minutos antes de deitar?</h3>
                    <div className="grid gap-3">
                    ...
                    <LiteraturaCard texto="A luz azul emitida pelas telas inibe a produção de melatonina (o hormônio do sono) pela glândula pineal, 'enganando' o cérebro para que ele ache que ainda é dia." />
                  </div>
                )}
                ...
                {currentStep === 7 && (
                  <div>
                    <h3 className="text-xl font-semibold mb-6">7. Estado Mental: Ao deitar, como você descreveria seus pensamentos?</h3>
                    <div className="grid gap-3">
                    ...
                    <LiteraturaCard texto="A hiperestimulação cognitiva é uma das maiores causas de insônia psicofisiológica. Se o cérebro está em modo de 'resolução de problemas', ele mantém o cortisol alto, o que é antagônico ao sono." />
                  </div>
                )}
                ...
                {currentStep === 8 && (
                  <div>
                    <h3 className="text-xl font-semibold mb-6">8. Sonolência Diurna (Escala de Epworth): Como você se sente durante suas atividades diárias?</h3>
                    <div className="grid gap-3">
                    ...
                    <LiteraturaCard texto="Mede o impacto da qualidade do sono na vida real. Um score alto aqui pode indicar distúrbios como a apneia do sono ou má eficiência respiratória noturna." />
                  </div>
                )}
                ...
                {currentStep === 9 && (
                  <div>
                    <h3 className="text-xl font-semibold mb-6">9. Ambiente Sensorial: Como você avalia o local onde dorme (Luz, Som, Temperatura)?</h3>
                    <div className="grid gap-3">
                      ...
                      <OptionButton label="Muito desconfortável (calor extremo/ruído alto)" value="inadequado" state={ambiente} setState={setAmbiente} />
                    </div>
                    <LiteraturaCard texto="O corpo precisa de uma queda na temperatura interna para iniciar o sono. Ruídos e luzes fragmentam o sono mesmo que você não chegue a acordar totalmente (microdespertares)." />
                  </div>
                )}
                ...
                {currentStep === 10 && (
                  <div>
                    ...
                    <LiteraturaCard texto="O sono é um processo ativo de restauração cognitiva e emocional. A percepção de prejuízo funcional durante o dia é um dos critérios fundamentais para o diagnóstico clínico de insônia. Déficits de sono afetam a regulação do cortisol, a consolidação da memória e aumentam o tempo de reação." />
                  </div>
                )}
                ...
                {currentStep === 11 && (
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mb-4">
                      Sinta-se à vontade para descrever a sua rotina com mais detalhes (horários de trabalho, turnos, pensamentos, estresse). A IA usará este texto para personalizar ainda mais o seu diagnóstico.
                    </p>
                    <textarea 
                      value={descricaoLivre}
                      onChange={e => setDescricaoLivre(e.target.value)}
                      placeholder="Ex: Trabalho de plantão algumas vezes por semana e nos outros dias tento dormir às 23h. Tenho muita dificuldade de pegar no sono quando o dia foi estressante..."
              ...
              <div className="pt-8 mt-4 border-t border-gray-800 flex items-center justify-between">
                ...
                {currentStep < totalSteps - 1 ? (
                  ...
                  >
                    {loading ? "Salvando..." : "Gerar Diagnóstico Mágico ✨"}
                  </button>
                )}
              </div>
            </div>
